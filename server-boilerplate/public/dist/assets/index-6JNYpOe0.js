...
z.isValidElement = ki;
z.lazy = function (e) {
  return { $$typeof: Df, _payload: { _status: -1, _result: e }, _init: Bf };
};
z.memo = function (e, t) {
 ...
 */ (function (e) {
  ...
  function r(_) {
    ...
    if (L !== O) {
      _[0] = L;
      e: for (var X = 0, Z = _.length, mr = Z >>> 1; X < mr; ) {
        var _t = 2 * (X + 1) - 1,
          Vl = _[_t],
          Nt = _t + 1,
          yr = _[Nt];
        if (0 > l(Vl, L))
          Nt < Z && 0 > l(yr, Vl)
            ? ((_[X] = yr), (_[Nt] = L), (X = Nt))
            : ((_[X] = Vl), (_[_t] = L), (X = _t));
        else if (Nt < Z && 0 > l(yr, L)) (_[X] = yr), (_[Nt] = L), (X = Nt);
        else break e;
      }
    }
    return O;
  ...
  function w(_) {
    if (((v = !1), h(_), !y))
      if (n(s) !== null) (y = !0), $l(C);
        ...
        var O = n(a);
        O !== null && Hl(w, O.startTime - _);
      }
  }
  function C(_, O) {
    (y = !1), v && ((v = !1), d(T), (T = -1)), (E = !0);
    var L = m;
    try {
      for (
        h(O), f = n(s);
      ...
      if (f !== null) var mr = !0;
        ...
        var _t = n(a);
        _t !== null && Hl(w, _t.startTime - O), (mr = !1);
      }
      return mr;
    } finally {
      (f = null), (m = L), (E = !1);
      ...
      return (
        ...
        L > X
          ? ((_.sortIndex = L),
            ...
            n(s) === null &&
              _ === n(a) &&
              (v ? (d(T), (T = -1)) : (v = !0), Hl(w, L - X)))
          : ((_.sortIndex = Z), t(s, _), y || E || ((y = !0), $l(C))),
        _
      );
    }),
...
function sn(e, t) {
  for (Wn[e] = t, e = 0; e < t.length; e++) ta.add(t[e]);
}
var Ze = !(
    typeof window > "u" ||
...
function ha() {
  if (nn) {
    var e = nn,
      t = rn;
    if (((rn = nn = null), Ou(e), t)) for (e = 0; e < t.length; e++) Ou(t[e]);
  }
}
function ma(e, t) {
  return e(t);
...
function id(e, t, n, r, l, o, i, u, s) {
  (Dn = !1), (Gr = null), ld.apply(od, arguments);
}
function ud(e, t, n, r, l, o, i, u, s) {
  if ((id.apply(this, arguments), Dn)) {
    if (Dn) {
      var a = Gr;
      (Dn = !1), (Gr = null);
...
function wa(e) {
  return (e = sd(e)), e !== null ? Sa(e) : null;
}
function Sa(e) {
...
function Dr(e) {
  ...
  for (var t = e.targetContainers; 0 < t.length; ) {
    ...
    } else return (t = fr(n)), t !== null && zi(t), (e.blockedOn = n), !1;
    t.shift();
  }
  return !0;
}
...
function ji(e, t, n, r) {
  if (el) {
    var l = Bo(e, t, n, r);
    if (l === null) oo(e, t, r, tl, n), ju(e, r);
    else if (Ed(l, e, t, n, r)) r.stopPropagation();
    else if ((ju(e, r), t & 4 && -1 < Sd.indexOf(e))) {
      for (; l !== null; ) {
        var o = fr(l);
        if (
          (o !== null && Na(o),
...
var tl = null;
function Bo(e, t, n, r) {
  if (((tl = null), (e = Ri(r)), (e = Rt(e)), e !== null))
...
var vn = {
  ...
  kl = W({}, cr, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== Nn &&
            (Nn && e.type === "mousemove"
              ? ((Gl = e.screenX - Nn.screenX), (ql = e.screenY - Nn.screenY))
              : (ql = Gl = 0),
            (Nn = e)),
          Gl);
    },
  ...
  Du = ke(kl),
  Nd = W({}, kl, { dataTransfer: 0 }),
  Pd = ke(Nd),
  Td = W({}, cr, { relatedTarget: 0 }),
  Zl = ke(Td),
  Rd = W({}, vn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Od = ke(Rd),
  Ld = W({}, vn, {
...
var Md = W({}, cr, {
  ...
  Hd = ke($d),
  Vd = W({}, vn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Wd = ke(Vd),
  Qd = W({}, kl, {
    deltaX: function (e) {
...
var Jd = Ze && "TextEvent" in window && !In,
...
function Gd(e, t) {
  if (Qt)
    return e === "compositionend" || (!Ii && Fa(e, t))
      ? ((e = za()), (Ir = Fi = at = null), (Qt = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function Vu() {
  Mn && (Mn.detachEvent("onpropertychange", Ma), (Gn = Mn = null));
}
function Ma(e) {
  if (e.propertyName === "value" && xl(Gn)) {
    var t = [];
    Da(t, Gn, e, Ri(e)), va(Zd, t);
  }
}
function ep(e, t, n) {
  e === "focusin"
    ? (Vu(), (Mn = t), (Gn = n), Mn.attachEvent("onpropertychange", Ma))
    : e === "focusout" && Vu();
}
function tp(e) {
...
var Ie = typeof Object.is == "function" ? Object.is : lp;
function qn(e, t) {
  if (Ie(e, t)) return !0;
  ...
  if (!e[Nr]) {
    (e[Nr] = !0),
      ta.forEach(function (n) {
        n !== "selectionchange" && (ap.has(n) || lo(n, !1, e), lo(n, !0, e));
      });
  ...
  va(function () {
    ...
    e: {
      ...
      if (m !== void 0) {
        ...
        for (var c = a, h; c !== null; ) {
          ...
          if (
            (h.tag === 5 &&
              w !== null &&
              ((h = w),
              d !== null && ((w = Kn(c, d)), w != null && v.push(bn(c, w, h)))),
            R)
          )
            break;
          c = c.return;
        ...
        0 < v.length &&
          ((m = new E(m, y, null, n, p)), f.push({ event: m, listeners: v }));
      }
    }
    if (!(t & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (v = E, d = y, c = 0, h = v; h; h = Ht(h)) c++;
              for (h = 0, w = d; w; w = Ht(w)) h++;
              for (; 0 < c - h; ) (v = Ht(v)), c--;
              for (; 0 < h - c; ) (d = Ht(d)), h--;
              for (; c--; ) {
      ...
      T &&
        ...
        0 < N.length &&
          ...
          P ? (T.data = P) : ((P = Aa(n)), P !== null && (T.data = P)))),
        (P = Jd ? Yd(e, n) : Gd(e, n)) &&
...
function Bi(e) {
  for (; e === il; )
    (il = Gt[--qt]), (Gt[qt] = null), (ul = Gt[--qt]), (Gt[qt] = null);
  for (; e === Dt; )
    (Dt = xe[--Ce]),
      (xe[Ce] = null),
      (Ye = xe[--Ce]),
...
function bo(e, t, n, r) {
  ...
  typeof o == "object" && o !== null
    ? (l.context = Te(o))
    : ((o = me(t) ? At : ue.current), (l.context = an(e, o))),
...
function lc(e) {
      ...
      : c !== null &&
        (c.elementType === C ||
          (typeof C == "object" &&
            ...
            C.$$typeof === ot &&
            us(C) === c.type))
      ? ((w = l(c, h.props)), (w.ref = Pn(d, c, h)), (w.return = d), w)
  ...
  function p(d, c, h, w, C) {
    return c === null || c.tag !== 7
      ? ((c = Ft(h, d.mode, w, C)), (c.return = d), c)
      : ((c = l(c, h)), (c.return = d), c);
  }
  function f(d, c, h) {
    ...
    if (typeof c == "object" && c !== null) {
      ...
      if (zn(c) || kn(c))
        return (c = Ft(c, d.mode, h, null)), (c.return = d), c;
      Rr(d, c);
    }
    return null;
  }
  function m(d, c, h, w) {
    ...
    if (typeof h == "object" && h !== null) {
      switch (h.$$typeof) {
        case gr:
          return h.key === C ? s(d, c, h, w) : null;
        case Vt:
          return h.key === C ? a(d, c, h, w) : null;
        case ot:
          return (C = h._init), m(d, c, C(h._payload), w);
      }
      if (zn(h) || kn(h)) return C !== null ? null : p(d, c, h, w, null);
      Rr(d, h);
    }
    return null;
  }
  function E(d, c, h, w, C) {
    if ((typeof w == "string" && w !== "") || typeof w == "number")
      return (d = d.get(h) || null), u(c, d, "" + w, C);
    if (typeof w == "object" && w !== null) {
      switch (w.$$typeof) {
        case gr:
          return (d = d.get(w.key === null ? h : w.key) || null), s(c, d, w, C);
        case Vt:
          return (d = d.get(w.key === null ? h : w.key) || null), a(c, d, w, C);
        case ot:
          var N = w._init;
          return E(d, c, h, N(w._payload), C);
      }
      if (zn(w) || kn(w)) return (d = d.get(h) || null), p(c, d, w, C, null);
      Rr(c, w);
    }
    return null;
  }
  function y(d, c, h, w) {
    for (
      var C = null, N = null, P = c, T = (c = 0), K = null;
      P !== null && T < h.length;
      T++
    ) {
    ...
    if (T === h.length) return n(d, P), B && Pt(d, T), C;
    if (P === null) {
      for (; T < h.length; T++)
        (P = f(d, h[T], w)),
          P !== null &&
            ((c = o(P, c, T)), N === null ? (C = P) : (N.sibling = P), (N = P));
      return B && Pt(d, T), C;
    }
  ...
  function v(d, c, h, w) {
    ...
    for (
      var N = (C = null), P = c, T = (c = 0), K = null, j = h.next();
      P !== null && !j.done;
      T++, j = h.next()
    ) {
      P.index > T ? ((K = P), (P = null)) : (K = P.sibling);
      var Oe = m(d, P, j.value, w);
      if (Oe === null) {
        P === null && (P = K);
        break;
      }
    ...
    if (j.done) return n(d, P), B && Pt(d, T), C;
    if (P === null) {
      for (; !j.done; T++, j = h.next())
        (j = f(d, j.value, w)),
          j !== null &&
            ((c = o(j, c, T)), N === null ? (C = j) : (N.sibling = j), (N = j));
      return B && Pt(d, T), C;
    }
    for (P = r(d, P); !j.done; T++, j = h.next())
      (j = E(P, d, T, j.value, w)),
        j !== null &&
      ...
      switch (h.$$typeof) {
        case gr:
          e: {
            ...
            h.type === Wt
              ? ((c = Ft(h.props.children, d.mode, w, h.key)),
                (c.return = d),
                (d = c))
              : ((w = Qr(h.type, h.key, h.props, null, d.mode, w)),
                (w.ref = Pn(d, c, h)),
        ...
        case Vt:
          e: {
            ...
            (c = yo(h, d.mode, w)), (c.return = d), (d = c);
          }
          return i(d);
        case ot:
          return (N = h._init), R(d, c, N(h._payload), w);
      }
      if (zn(h)) return y(d, c, h, w);
    ...
    return (typeof h == "string" && h !== "") || typeof h == "number"
      ? ((h = "" + h),
        c !== null && c.tag === 6
          ...
          : (n(d, c), (c = mo(h, d.mode, w)), (c.return = d), (d = c)),
        i(d))
      : n(d, c);
  }
  return R;
...
function qi(e, t, n, r, l, o) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Br.current = e === null || e.memoizedState === null ? xp : Cp),
    (e = n(r, l)),
    Bn)
  ) {
    o = 0;
...
function Ec(e, t, n) {
  return It & 21
    ? (Ie(n, t) || ((n = Ca()), (V.lanes |= n), (Mt |= n), (e.baseState = !0)),
      t)
...
function kp(e, t, n) {
  ...
  if (xc(e)) Cc(t, l);
    ...
    (n = ec(e, t, l, r)),
      n !== null && ((l = ae()), De(n, e, r, l), _c(n, t, r));
  }
}
function xc(e) {
  var t = e.alternate;
...
function ms(e, t, n, r, l) {
  ...
  if ((on(t, l), t.stateNode === null))
    Hr(e, t), rc(t, n, r), bo(t, n, r, l), (r = !0);
  else if (e === null) {
    var i = t.stateNode,
      u = t.memoizedProps;
    i.props = u;
    ...
    u !== f || m !== y || he.current || it
      ? (typeof E == "function" && (Zo(t, n, E, r), (y = t.memoizedState)),
...
function ys(e, t, n, r, l) {
  return cn(), $i(l), (t.flags |= 256), se(e, t, n, r), t.child;
}
...
function Tp(e, t, n, r, l, o, i) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = po(Error(S(422)))), Or(e, t, i, r))
      : t.memoizedState !== null
  ...
  if (l.data === "$!") {
    ...
    return (r = u), (o = Error(S(419))), (r = po(o, r, void 0)), Or(e, t, i, r);
  }
  if (((u = (i & e.childLanes) !== 0), pe || u)) {
    ...
    return uu(), (r = po(Error(S(421)))), Or(e, t, i, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
  ...
  switch ((Bi(t), t.tag)) {
    ...
    case 6:
      if (e && t.stateNode != null) Dc(e, t, e.memoizedProps, r);
        ...
        if (((n = Lt(nr.current)), Lt(We.current), Tr(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Be] = t),
...
function jp(e, t) {
  ...
  for (Wo = { focusedElem: e, selectionRange: n }, el = !1, x = t; x !== null; )
...
function Ic(e) {
  ...
  t !== null && ((e.alternate = null), Ic(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Be], delete t[er], delete t[Xo], delete t[mp], delete t[yp])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Bc(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      Le(t, e), Me(e), r & 512 && n !== null && bt(n, n.return);
      break;
    case 5:
      if (
        (Le(t, e),
...
function De(e, t, n, r) {
  if (50 < Vn) throw ((Vn = 0), (fi = null), Error(S(185)));
  ar(e, n, r),
    (!(A & 2) || e !== ee) &&
      (e === ee && (!(A & 2) && (Ol |= n), q === 4 && st(e, ne)),
      ye(e, r),
      n === 1 && A === 0 && !(t.mode & 1) && ((hn = J() + 500), Nl && Ct()));
}
function ye(e, t) {
...
function Hc(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = vl(e, r);
    ...
    A |= 2;
    var o = Wc();
    (ee !== e || ne !== t) && ((Ke = null), (hn = J() + 500), jt(e, t));
    do
      try {
        Mp();
        break;
  ...
  if (t !== 0) {
    if (
      (t === 2 && ((l = Mo(e)), l !== 0 && ((r = l), (t = di(e, l)))), t === 1)
    )
      throw ((n = ir), jt(e, 0), st(e, r), ye(e, J()), n);
    if (t === 6) st(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = Ko(Tt.bind(null, e, de, Ke), t);
            break;
          }
          Tt(e, de, Ke);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = Ko(Tt.bind(null, e, de, Ke), r);
            break;
          }
          Tt(e, de, Ke);
          break;
...
function Cs(e) {
  ...
  if (n === 1) throw ((n = ir), jt(e, 0), st(e, t), ye(e, J()), n);
...
function ou(e, t) {
  ...
  try {
    ...
    (A = n), A === 0 && ((hn = J() + 500), Nl && Ct());
  }
}
function Ut(e) {
  ct !== null && ct.tag === 0 && !(A & 6) && un();
  var t = A;
  A |= 1;
  var n = Ne.transition,
    r = D;
  try {
    ...
    (D = r), (Ne.transition = n), (A = t), !(A & 6) && Ct();
  }
}
function iu() {
  (ve = en.current), U(en);
...
function vl(e, t) {
  ...
  while (!0);
  if ((Vi(), (A = n), (hl.current = r), Y !== null)) throw Error(S(261));
...
function Tt(e, t, n) {
  var r = D,
    l = Ne.transition;
  try {
    (Ne.transition = null), (D = 1), Up(e, t, n, r);
  } finally {
    (Ne.transition = l), (D = r);
  }
  return null;
  ...
  if (ct !== null) {
    ...
    try {
      if (((Ne.transition = null), (D = 16 > e ? 16 : e), ct === null))
        ...
        if (((e = ct), (ct = null), (yl = 0), A & 6)) throw Error(S(331));
        var l = A;
        ...
        if (
          ((A = l), Ct(), Ve && typeof Ve.onPostCommitFiberRoot == "function")
        )
          try {
      ...
      e: {
        ...
        if (((r = i.element), o.isDehydrated))
          if (
            ...
            (l = pn(Error(S(423)), t)), (t = ys(e, t, r, n, l));
            break e;
          } else if (r !== l) {
            (l = pn(Error(S(424)), t)), (t = ys(e, t, r, n, l));
            break e;
          } else
            for (
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Li(t, n | 1), ye(t, J()), !(A & 6) && ((hn = J() + 500), Ct()));
      }
      break;
    case 13:
      Ut(function () {
...
ma = ou;
ya = Ut;
var Yp = { usingClientEntryPoint: !1, Events: [fr, Jt, _l, pa, ha, ou] },
  Rn = {
  ...
  Gp = {
    ...
    findFiberByHostInstance: Rn.findFiberByHostInstance || Xp,
...
var ef = {
  ...
  Rs = zt.createContext && zt.createContext(ef),
  wt = function () {
    return (
      (wt =
        Object.assign ||
...
function tf(e) {
  return (
    e &&
    e.map(function (t, n) {
      return zt.createElement(t.tag, wt({ key: n }, t.attr), tf(t.child));
    })
  );
}
function nf(e) {
  return function (t) {
    return zt.createElement(bp, wt({ attr: wt({}, e.attr) }, t), tf(e.child));
  };
}
function bp(e) {
  var t = function (n) {
  ...
  return Rs !== void 0
    ? zt.createElement(Rs.Consumer, null, function (n) {
        return t(n);
      })
    : t(ef);
}
      ...
      children: k.jsxs("div", {
        ...
        children: [
          ...
          k.jsxs("div", {
            ...
            children: [
              k.jsx("h5", { className: "productTitle", children: t }),
              k.jsxs("div", {
              ...
              k.jsxs("div", {
                children: [k.jsx(th, {}), k.jsx("span", { children: o })],
              }),
            ],
          }),
          k.jsx("button", { children: "Add to Cart" }),
        ],
      }),
    }),
  });
}
function rh({ products: e }) {
  return k.jsx("div", {
    className: "allContainer",
    children: e.map((t, n) => $e.createElement(nh, { ...t, key: n })),
  });
}
function rf(e, t) {
  return function () {
...
const vh = (e, t, n, { allOwnKeys: r } = {}) => (
  ...
  Ls = "0123456789",
  ff = { DIGIT: Ls, ALPHA: vo, ALPHA_DIGIT: vo + vo.toUpperCase() + Ls },
  jh = (e = 16, t = ff.ALPHA_DIGIT) => {
    let n = "";
    const { length: r } = t;
...
const Ah = (e) => {
  ...
  Dh = Qe("AsyncFunction"),
  Ih = (e) => e && (Ml(e) || Pe(e)) && Pe(e.then) && Pe(e.catch),
  g = {
    isArray: wn,
    isArrayBuffer: lf,
    isBuffer: oh,
...
const Bh = g.toFlatObject(g, {}, null, function (t) {
...
function Ul(e, t, n) {
  ...
  function p(y, v, R) {
    ...
    return mi(y) ? !0 : (t.append(zs(R, v, o), a(y)), !1);
  }
  const f = [],
    m = Object.assign(Bh, {
      defaultVisitor: p,
...
const vf = {
  ...
  Hh = typeof URLSearchParams < "u" ? URLSearchParams : hu,
  ...
  transformRequest: [
    function (t, n) {
      ...
      if ((o && g.isHTMLForm(t) && (t = new FormData(t)), g.isFormData(t)))
        return l && l ? JSON.stringify(wf(t)) : t;
      if (
        g.isArrayBuffer(t) ||
        g.isBuffer(t) ||
        g.isStream(t) ||
  ...
  pm =
    ...
    function (e) {
      return new Promise(function (n, r) {
        ...
        f.open(e.method.toUpperCase(), yf(m, e.params, e.paramsSerializer), !0),
          (f.timeout = e.timeout);
        function E() {
          if (!f) return;
          const v = qe.from(
  ...
  kf = {
    getAdapter: (e) => {
      ...
      for (let o = 0; o < t; o++) {
        ...
        if (
          ((r = n),
          !hm(n) && ((r = yi[(i = String(n)).toLowerCase()]), r === void 0))
        )
...
const vi = { assertOptions: mm, validators: vu },
  lt = vi.validators;
class wl {
  constructor(t) {
    (this.defaults = t),
...
$.mergeConfig = mn;
$.AxiosHeaders = qe;
$.formToJSON = (e) => wf(g.isHTMLForm(e) ? new FormData(e) : e);
$.getAdapter = kf.getAdapter;
$.HttpStatusCode = wm;
$.default = $;
const Sm = () => {
  const [e, t] = $e.useState({}),
    ...
    r = async (o) => {
      o.preventDefault(), console.log(e), await l(e);
    },
    l = async (o) => {
      try {
        const i = await $.post("/products", o);
        console.log(i.data);
      } catch (i) {
        console.error("Error adding product:", i);
      }
    };
  return k.jsx("form", {
    className: "form-horizontal",
    onSubmit: r,
    children: k.jsxs("fieldset", {
      className: "form-container",
      children: [
        k.jsx("legend", { children: "Add Product" }),
        k.jsxs("div", {
          className: "form-group",
          children: [
            k.jsx("label", { htmlFor: "title", children: "Title" }),
            k.jsx("input", {
              id: "title",
              name: "title",
              type: "text",
        ...
        k.jsxs("div", {
          className: "form-group",
          children: [
            k.jsx("label", { htmlFor: "thumbnail", children: "Thumbnail" }),
            k.jsx("input", {
              id: "thumbnail",
              name: "thumbnail",
              type: "text",
        ...
        k.jsxs("div", {
          className: "form-group",
          children: [
            k.jsx("label", { htmlFor: "price", children: "Price" }),
            k.jsx("input", {
              id: "price",
              name: "price",
              type: "number",
        ...
        k.jsxs("div", {
          className: "form-group",
          children: [
            k.jsx("label", { htmlFor: "category", children: "Category" }),
            k.jsxs("select", {
              id: "category",
              name: "category",
              className: "form-control",
              ...
              required: !0,
              children: [
                k.jsx("option", { value: "", children: "Choose" }),
                k.jsx("option", {
                  value: "smartphone",
                  children: "SmartPhone",
                }),
                k.jsx("option", { value: "laptops", children: "Laptops" }),
              ],
            }),
          ],
        }),
        k.jsxs("div", {
          className: "form-group",
          children: [
            k.jsx("label", { htmlFor: "brand", children: "Brand" }),
            k.jsxs("select", {
              id: "brand",
              name: "brand",
              className: "form-control",
              ...
              children: [
                k.jsx("option", { value: "", children: "Choose" }),
                k.jsx("option", { value: "apple", children: "Apple" }),
                k.jsx("option", { value: "samsung", children: "Samsung" }),
              ],
            }),
          ],
        }),
        k.jsxs("div", {
          ...
          children: [
            ...
            k.jsx("span", {
              ...
              children: "Optional: Discount Percentage",
            }),
          ],
        }),
        k.jsx("div", {
...
function Em({
  ...
  return k.jsxs("div", {
    className: "productadContainer",
    children: [
      k.jsxs("div", {
        className: "imgntitle",
        children: [k.jsx("img", { src: n }), k.jsx("h3", { children: t })],
      }),
      k.jsxs("div", {
        className: "otherInfo",
        children: [
          k.jsxs("p", { children: ["Price:", r, "$"] }),
          k.jsxs("p", { children: ["discountPercentage:", l, "%"] }),
          k.jsxs("p", { children: ["rating:", o] }),
        ],
      }),
      k.jsx("div", {
        className: "buttons",
        children: k.jsx("button", { onClick: () => i(e), children: "Delete" }),
      }),
      k.jsx("p", {}),
    ],
  });
...
function km({
  ...
  return (
    console.log("adminpanel", e),
    k.jsxs("div", {
      className: "AdminPanel",
      children: [
        k.jsx("h1", { className: "admintitle", children: "Admin Panel" }),
        k.jsx(Sm, { handleUpdate: r, handleReplace: n }),
        k.jsx("div", {
          ...
          children:
            e == null
              ? void 0
              : e.map((l, o) =>
                  $e.createElement(Em, { ...l, key: o, handleDelete: t })
                ),
        }),
      ],
    })
...
function xm({ children: e }) {
  return k.jsx("div", { className: "container", children: e });
}
function Cm() {
  const [e, t] = $e.useState([]),
    [n, r] = $e.useState(null),
    ...
    o(!0),
      (async () => {
        try {
          ...
          console.log(p.data), t(p.data);
        } catch (p) {
          console.log(p), r(p.message);
        } finally {
          o(!1);
        }
      })();
  ...
  const i = async (a) => {
      const p = await $.delete(`/products/${a}`);
      console.log(p.data),
        p.data._id && t(e.filter((f) => f._id !== p.data._id));
    },
    u = async (a) => {
      const p = await $.delete(`https://localhost:8080/products/${a}`);
      console.log(p.data);
    },
    s = async (a) => {
      const p = await $.delete(`https://localhost:8080/products/${a}`);
...
Eo.createRoot(document.getElementById("root")).render(k.jsx(Cm, {}));
